    ...
    public class AccountController : Controller {
        ...
        private bool ValidateRegistration(string userName, string email, string password, string confirmPassword) {
            ...
            if (String.IsNullOrEmpty(userName)) {
                ...
                if (userName.Length >= UserPartRecord.MaxUserNameLength) {
            ...
            else if (email.Length >= UserPartRecord.MaxEmailLength) {
                ModelState.AddModelError("email", T("The email address you provided is too long."));
                validate = false;
            }
            else if (!Regex.IsMatch(email, UserPartRecord.EmailPattern, RegexOptions.IgnoreCase)) {
