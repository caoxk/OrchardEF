...
{
    public class TemplateFilterForPart<TPart> : TemplateFilterBase<DocumentPart> where TPart : DocumentPart, new() {
        ...
        protected override void BuildEditorShape(BuildEditorContext context, DocumentPart part) {
        ...
        protected override void UpdateEditorShape(UpdateEditorContext context, DocumentPart part) {
            if (!string.Equals(_groupId, context.GroupId, StringComparison.OrdinalIgnoreCase))
                return;
