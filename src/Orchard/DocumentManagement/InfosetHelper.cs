...
namespace Orchard.DocumentManagement {
    public static class InfosetHelper {
        ...
        public static TProperty Retrieve<TPart, TProperty>(this TPart contentPart,
            ...
            bool versioned = false) where TPart : DocumentPart {
        ...
        public static TProperty Retrieve<TProperty>(this DocumentPart contentPart, string name, 
        ...
        public static TProperty Retrieve<TPart, TRecord, TProperty>(this TPart contentPart,
            ...
            if (infosetPart == null) {
                ...
                var infoset = infosetPart.Infoset.Element;
