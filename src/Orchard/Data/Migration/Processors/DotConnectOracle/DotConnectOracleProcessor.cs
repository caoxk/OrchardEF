...
namespace Orchard.Data.Migration.Processors.DotConnectOracle
{
    public class DotConnectOracleProcessor : GenericProcessorBase
    {
        ...
        public DotConnectOracleProcessor(ITransactionManager transactionManager, IMigrationGenerator generator, IAnnouncer announcer, IMigrationProcessorOptions options, DotConnectOracleDbFactory factory)
