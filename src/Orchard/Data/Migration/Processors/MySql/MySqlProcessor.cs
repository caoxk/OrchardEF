...
namespace Orchard.Data.Migration.Processors.MySql
{
    public class MySqlProcessor : GenericProcessorBase
    {
        ...
        public MySqlProcessor(ITransactionManager transactionManager, IMigrationGenerator generator, IAnnouncer announcer, IMigrationProcessorOptions options, IDbFactory factory)
