...
namespace Orchard.Data.Migration.Processors.SqlServer
{
    public class SqlServer2012ProcessorFactory : MigrationProcessorFactory
    {
        ...
        public SqlServer2012ProcessorFactory(ITransactionManager transactionManager)
        {
        ...
        public override IMigrationProcessor Create(IAnnouncer announcer, IMigrationProcessorOptions options)
        {
            ...
            return new SqlServerProcessor(_transactionManager, new SqlServer2012Generator(), announcer, options, factory);
        }
    }
}