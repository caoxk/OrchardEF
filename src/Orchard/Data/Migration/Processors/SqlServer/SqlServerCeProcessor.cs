...
namespace Orchard.Data.Migration.Processors.SqlServer
{
    public sealed class SqlServerCeProcessor : GenericProcessorBase
    {
        ...
        public SqlServerCeProcessor(ITransactionManager transactionManager, IMigrationGenerator generator, IAnnouncer announcer, IMigrationProcessorOptions options, IDbFactory factory)
        ...
        private IEnumerable<string> SplitIntoSingleStatements(string sql)
        {
            ...
            foreach (string line in sql.Split(new string[] { System.Environment.NewLine }, StringSplitOptions.None))
            {
