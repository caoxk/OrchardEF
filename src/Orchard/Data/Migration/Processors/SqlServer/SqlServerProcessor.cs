...
namespace Orchard.Data.Migration.Processors.SqlServer
{
    public sealed class SqlServerProcessor : GenericProcessorBase
    {
        ...
        public SqlServerProcessor(ITransactionManager transactionManager, IMigrationGenerator generator, IAnnouncer announcer, IMigrationProcessorOptions options, IDbFactory factory)
