...
namespace Orchard.Data.Migration.Processors.SqlServer
{
    public class SqlServer2000ProcessorFactory : MigrationProcessorFactory
    {
        ...
        public SqlServer2000ProcessorFactory(ITransactionManager transactionManager)
        {
        ...
        public override IMigrationProcessor Create(IAnnouncer announcer, IMigrationProcessorOptions options)
        {
            ...
            return new SqlServer2000Processor(_transactionManager, new SqlServer2000Generator(), announcer, options, factory);
        }
    }
}