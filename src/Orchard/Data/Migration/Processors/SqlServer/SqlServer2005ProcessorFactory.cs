...
namespace Orchard.Data.Migration.Processors.SqlServer
{
    public class SqlServer2005ProcessorFactory : MigrationProcessorFactory
    {
        ...
        public SqlServer2005ProcessorFactory(ITransactionManager transactionManager)
        {
        ...
        public override IMigrationProcessor Create(IAnnouncer announcer, IMigrationProcessorOptions options)
        {
            ...
            return new SqlServerProcessor(_transactionManager, new SqlServer2005Generator(), announcer, options, factory);
        }
    }
}