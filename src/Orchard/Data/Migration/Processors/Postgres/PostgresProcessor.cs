...
namespace Orchard.Data.Migration.Processors.Postgres
{
    public class PostgresProcessor : GenericProcessorBase
    {
        ...
        public PostgresProcessor(ITransactionManager transactionManager, IMigrationGenerator generator, IAnnouncer announcer, IMigrationProcessorOptions options, IDbFactory factory)
