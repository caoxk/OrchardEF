...
using Orchard.Data.Migration.Generators.Generic;
...
namespace Orchard.Data.Migration.Generators.SqlServer
{
    public class SqlServer2000Generator : GenericGenerator
    {
        ...
        protected virtual void BuildDelete(DeleteColumnExpression expression, string columnName, StringBuilder builder) 
        {
            ...
            builder.AppendLine(String.Format("-- now we can finally drop column" + System.Environment.NewLine + "ALTER TABLE {0} DROP COLUMN {1};",
        ...
        public override string Generate(AlterDefaultConstraintExpression expression)
        {
            ...
            builder.Append(String.Format("-- create alter table command to create new default constraint as string and run it" + System.Environment.NewLine +"ALTER TABLE {0} WITH NOCHECK ADD CONSTRAINT {3} DEFAULT({2}) FOR {1};",
                Quoter.QuoteTableName(expression.TableName),
        ...
        {
            throw new DatabaseOperationNotSupportedException("Sequences are not supported in SqlServer2000");
        }
        ...
        public override string Generate(DeleteDefaultConstraintExpression expression)
        {
            string sql =
                ...
                "WHERE parent_object_id = object_id('{0}')" + System.Environment.NewLine +
                ...
                "WHERE object_id = object_id('{0}')" + System.Environment.NewLine +
                "AND name = '{1}'" + System.Environment.NewLine +
                ");" + System.Environment.NewLine + System.Environment.NewLine +
                "-- create alter table command to drop constraint as string and run it" + System.Environment.NewLine +
                "SET @sql = N'ALTER TABLE {0} DROP CONSTRAINT ' + @default;" + System.Environment.NewLine + 
