...
namespace Orchard.Data.Migration.Generators.SqlServer
{
    public class SqlServer2005Generator : SqlServer2000Generator
    {
        ...
        protected override void BuildDelete(DeleteColumnExpression expression, string columnName, StringBuilder builder)
        {
            ...
            builder.AppendLine(String.Format("-- now we can finally drop column" + System.Environment.NewLine + "ALTER TABLE {2}.{0} DROP COLUMN {1};",
                                         Quoter.QuoteTableName(expression.TableName),
        ...
        public override string Generate(AlterDefaultConstraintExpression expression)
        {
            ...
            builder.Append(String.Format("-- create alter table command to create new default constraint as string and run it" + System.Environment.NewLine + "ALTER TABLE {3}.{0} WITH NOCHECK ADD CONSTRAINT {4} DEFAULT({2}) FOR {1};",
                Quoter.QuoteTableName(expression.TableName),
        ...
        public override string Generate(DeleteDefaultConstraintExpression expression)
        {
            string sql =
                ...
                "WHERE parent_object_id = object_id('{2}.{0}')" + System.Environment.NewLine +
                ...
                "WHERE object_id = object_id('{2}.{0}')" + System.Environment.NewLine +
                ...
                "SET @sql = N'ALTER TABLE {2}.{0} DROP CONSTRAINT ' + @default;" + System.Environment.NewLine +
