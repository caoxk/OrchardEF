...
namespace Orchard.Data.Migration.Generators.SqlServer
{
    public class SqlServer2012Generator : SqlServer2008Generator
    {
        ...
        public override string Generate(FluentMigrator.Expressions.CreateSequenceExpression expression)
        {
        ...
        public override string Generate(FluentMigrator.Expressions.DeleteSequenceExpression expression)
        {
