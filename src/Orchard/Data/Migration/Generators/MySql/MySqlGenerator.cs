...
namespace Orchard.Data.Migration.Generators.MySql
{
    public class MySqlGenerator : GenericGenerator
    {
        ...
        {
            throw new DatabaseOperationNotSupportedException("Altering of default constraints is not supporteed for MySql");
        }

        public override string Generate(CreateSequenceExpression expression)
        {
            throw new DatabaseOperationNotSupportedException("Sequences is not supporteed for MySql");
        }
        ...
        {
            throw new DatabaseOperationNotSupportedException("Default constraints are not supported");
        }
    }
}
